...
if (!process.env.AUTH0_DOMAIN || !process.env.AUTH0_AUDIENCE || !process.env.AUTH0_HS256_SECRET) {
  throw 'Make sure you have AUTH0_DOMAIN, AUTH0_AUDIENCE, and AUTH0_HS256_SECRET in your .env file'
}
...
const authenticate = jwt({
  ...
  secret: process.env.AUTH0_HS256_SECRET,
...
// access token must contain a scope of read:messages
